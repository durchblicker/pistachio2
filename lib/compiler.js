...
Partial.prototype.parse = function(options, callback) {
  ...
  if(typeof options.testBasePath != 'undefined' && !templatePath.indexOf(options.standardBasePath+'/test')==0){
...
function parseTemplate(template, options, callback) {
  ...
  if(typeof options.testBasePath != 'undefined' && template.indexOf(options.standardBasePath)==0 && !template.indexOf(options.standardBasePath+'/test')==0){
